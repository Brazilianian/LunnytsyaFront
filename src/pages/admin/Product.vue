                ...
                <div class="d-flex my-2">
                  ...
                  <div class="w-75 ms-2">
                    ...
                    <div class="has-validation">
                      ...
                      <input id="price" type="number" min="0"  :class="productValidation.price !== undefined ? 'form-control is-invalid' : 'form-control'" v-model="product.price">
                    ...
                    <div class="has-validation">
                      ...
                      <textarea id="description"  :class="productValidation.description !== undefined ? 'form-control no-resize is-invalid' : 'form-control no-resize'" rows="7"
...
export default {
  ...
  methods: {
    ...
    async saveChanges() {
      ...
      if (result) {
        try {
          await axios.put(this.HTTP_REQUEST + '/product', this.product)
              .then(() => {
                    location.reload();
                  }
              )
    ...
    async deleteProduct() {
      ...
      if (result) {
        try {
          await axios.delete(this.HTTP_REQUEST + '/product/' + this.product.id)
              .then(() => {
                location.reload();
              })
    ...
    async getProduct() {
      try {
        await axios.get(this.HTTP_REQUEST + '/product/' + this.$route.params.id)
            .then(response => {
